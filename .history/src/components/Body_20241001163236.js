...
const Body = () => {
  ...
  return AllRestaurants?.length == 0 ? (
    ...
    <>
      <div className=" absolute inset-0 bg-cover bg-center bg-[url('https://img.freepik.com/free-photo/abstract-blur-supermarket_74190-4605.jpg?w=900&t=st=1727780425~exp=1727781025~hmac=cf4f736e1f2acfa96e4be00324cd99e3cff557a0ccfcafb72bc63747e5e1d73c')] bg-no-repeat bg-fixed opacity-80">
        <input
          type="text"
