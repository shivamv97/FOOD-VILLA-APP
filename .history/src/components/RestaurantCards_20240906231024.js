...
const RestrauntCard = ({
  ...
  return (
    <div className="w-52 m-2 p-10 bg-pink-50  hover:scale-105 hover:shadow-lg transition-transform duration-300 ease-in-out">
      <img src={Img_cdn_url + cloudinaryImageId} />
      <h2 className="font-bold text-xl">{name}</h2>
      <h3 className="break-words text-gray-500">{cuisines.join(",")}</h3>
